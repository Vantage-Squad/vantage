...
object UsersTable : Table("users") {
    ...
    val createdAt = timestamp("created_at").defaultExpression(org.jetbrains.exposed.sql.javatime.CurrentDateTime)
...
object AccountStatesTable : Table("account_states") {
    ...
    val lastSeen = timestamp("last_seen").defaultExpression(org.jetbrains.exposed.sql.javatime.CurrentDateTime)
